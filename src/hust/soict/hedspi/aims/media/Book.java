...
public class Book extends Media {
    ...
    public void addAuthor(String authorName) throws IllegalArgumentException {
        if (this.authors.contains(authorName)) {
            ...
            throw new IllegalArgumentException("ERROR: Author's name already exists in 's Authors List!");
        }
    }
    ...
    public void removeAuthor(String authorName) throws IllegalArgumentException {
        if (this.authors.contains(authorName)) {
            ...
            throw new IllegalArgumentException("ERROR: Author's name does not exist in Authors List!");
        }
    }
